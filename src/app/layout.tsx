...
export const metadata: Metadata = {
  title: "Burger King - Flame-Grilled Burgers & Quality Meals",
  description: "Experience delicious flame-grilled burgers at Burger King. Fresh ingredients, fast service, and bold flavors in every bite.",
  keywords: "burgers, fast food, flame-grilled, restaurant, quality meals",
  robots: {
    index: true,
    follow: true
  }
